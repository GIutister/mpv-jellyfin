...
local function connect()
    ...
    local request = mp.command_native({
        ...
        capture_stderr = true,
        playback_only = false,
        args = {"curl", options.url.."/Users/AuthenticateByName", "-H", "accept: application/json", "-H", "content-type: application/json", "-H", "x-emby-authorization: MediaBrowser Client=\""..mpv_version.."\", Device=\"mpv\", DeviceId=\"1\", Version=\"‎ \"", "-d", "{\"username\":\""..options.username.."\",\"Pw\":\""..options.password.."\"}"}
    })
